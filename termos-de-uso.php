        ...
        <section class="container-fluid mx-0 p-2 p-sm-4 p-md-5 bg-light">
            <article class="container">
                <section class="row my-3">
                    <header class="col-12 p-5 bg-pink">
                        <h3 class="mb-3"><b>Aviso Importante</b></h3>
                ...
                <section class="row my-3">
                    ...
                    <article class="col-12 my-3">
                        <p class="col-12 mt-3">Esses Termos de Uso apresentam as Regras e Condições Gerais aplicáveis ao uso dos serviços oferecidos pela <b>agilmindset</b> - projeto idealizado e executado exclusivamente pela "Djament Comunicação", nome fantasia da empresa tipo MEI Marcelo Diament37484380873, inscrita no CNPJ sob n.º 20.196.856/0001-91, doravante denominada "<b>agilmindset</b>", o qual consiste em uma ferramenta digital - mais especificamente uma plataforma online - que otimiza processos de maneira dinâmica, interativa e colaborativa.</p>
                        <p class="col-12 mb-3">Ao navegar no site e/ou na plataforma <b>agilmindset</b>, o usuário está expressamente ciente e de acordo com os Termos de Uso (e suas condições e regras) bem como com as <a href="./politicas-de-privacidade" target="_blank" rel="noopener noreferrer" title="Leia as políticas de privacidade da agilmindset">Políticas de Privacidade</a> do site <b>agilmindset</b>. Sendo assim, o aceite é obrigatório e indispensável para utilização dos serviços oferecidos pela <b>agilmindset</b>, sejam eles pagos ou gratuitos, com ou sem acesso restrito.</p>
                    </article>
                </section>
                <section class="row my-3">
