<section class="container-fluid formCadastroSection mx-0 p-0">
  ...
  <article class="col-12 row mx-auto px-4">
    <form class="mt-0 mb-3 mx-auto" action="" method="post" autocomplete="off" id="formCadastroUsuario">
      <div class="form-row">
      ...
      <div class="form-group form-check">
        <input type="checkbox" class="form-check-input" value="true" id="aceitePoliticasFormCadastro" name="aceitePoliticasFormCadastro" tab-index="2" required checked>
      ...
      <button type="submit" class="btn btn-dark float-right" value="cadastrarUsuario" title="Enviar informações para cadastro">Login</button>
    </form>
    <p class="col-12 mt-3 text-center">Opa! Ainda não tenho conta, preciso <a href="./cadastrar-usuario.php" rel="next" title="Cadastre-se">me cadastrar</a></p>
  </article>
</section>