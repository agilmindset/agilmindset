<section class="container-fluid formCadastroSection mx-0 p-5">
    ...
    <form class="my-3 mx-auto" action="" method="post" autocomplete="on" id="formCadastroUsuario">
      <div class="form-row">
        <div class="form-group col">
          ...
          <input type="text" class="form-control" id="inputNome" name="inputNome" aria-describedby="nomeHelp" placeholder="Fulano" min-length="2" max-length="35" required auto-focus tab-index="0">
